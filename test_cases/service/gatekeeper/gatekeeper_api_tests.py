...
class TestGateKeeperAPI:
    ...
    def test_return_user_info_with_no_application(self):
        """
        GATEKEEPER-API025 test_return_user_info_with_no_application -
        Ensures user info CANNOT be return from the user api when no
        application  is provided
        """
        # urlencoded post
        ...
        # TODO: uncomment checks when correct error message si returned
        # and correct status code
        # https://www.pivotaltracker.com/story/show/61542566
