...
class TestGateUserAppAssocationAPI(unittest.TestCase):
    ...
    def test_user_grp_assoc_api_create(self):
        ...
        self.assertEquals(
            user_grp_data['user_id'],
            create_response.json()['user_id']
            )
        self.assertEquals(
            user_grp_data['group_id'],
    ...
    def test_user_grp_assoc_api_miss_params(self):
        ...
        for dict in no_data:
            data = self.gk_service.create_user_grp_data(session, dict)
            create_response = self.gk_service.gk_crud(
    ...
    def test_user_grp_assoc_api_no_update(self):
        ...
        create_response = self.gk_service.gk_crud(
            session, method='PUT', resource="user_grp", data=user_grp_data
        )
