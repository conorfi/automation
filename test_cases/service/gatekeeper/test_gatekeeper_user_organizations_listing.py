...
class TestGateKeeperUsersOrgsListingAPI(unittest.TestCase):
    ...
    def test_user_orgs_api(self):
        """
        GATEKEEPER_USER_ORGS_API_001 test_user_orgs_api
        Ensure all the user_org information stored is returned
        """
        ...
        db_count = self.gk_dao.get_user_org_count(self.db)['count']
    ...
    def test_user_orgs_filter(self):
        ...
        for params in dict_matrix:
            ...
            self.assertEquals(response.json()[0]['organization_id'], org_id)
    ...
    def test_user_orgs_api_filter_no_data(self):
        """
        GATEKEEPER_USER_ORGS_API_003 test_user_orgs_api_filter_no_data
    ...
    def test_user_orgs_api_filter_invalid_data(self):
        """
        GATEKEEPER_USER_ORGS_API_004 test_user_orgs_api_filter_invalid_data
        Ensure the name filer works correctly when no
        or invalid data is entered
        """
        ...
        dict_matrix = [
            {'user_id': rand_int},
            {'organization_id': rand_int},
            {'user_id': rand_int, 'organization_id': rand_int}
        ]
