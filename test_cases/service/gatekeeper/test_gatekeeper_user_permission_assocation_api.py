...
class TestGateGrpPermAssocationAPI(ApiTestCase):
    ...
    def test_user_perm_assoc_api_create(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_001 test_user_perm_assoc_api_create
        ...
        #verify API
        self.assertUserPermData(create_response.json(), user_perm_data)
        # clean up
    ...
    def test_user_perm_assoc_api_miss_params(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_002 test_user_perm_assoc_api_miss_params
    ...
    def test_user_perm_assoc_api_no_data(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_003 test_user_perm_assoc_api_no_data
        ...
        no_data = {'user_id': None, 'permission_id': None}

        create_response = self.gk_service.gk_crud(
            session, method='POST', resource="user_perm", data=no_data
        )
    ...
    @attr(env=['test'], priority=1)
    def test_user_perm_assoc_api_create_dup(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_004 test_user_perm_assoc_api_create_dup
    ...
    def test_user_perm_assoc_api_no_update(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_005 test_user_perm_assoc_api_no_update
        update not allowed,
        clean up the data (implictly tests DELETE and GET)
        """
        # login and create session
    ...
    def test_user_perm_assoc_api_read(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_006 test_user_perm_assoc_api_read
        read the data
        ...
        self.assertUserPermData(read_response.json(), user_perm_data)
    ...
    def test_user_perm_ass_api_read_not_exis(self):
        ...
        non_existant_data = [
            ...
            {'user_id': self.util.random_int(),
             'permission_id': user_perm_data['permission_id']},
            {'user_id': user_perm_data['user_id'],
             'permission_id': self.util.random_int()}
    ...
    @attr(env=['test'], priority=1)
    def test_user_perm_assoc_api_delete(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_009 test_user_perm_assoc_api_delete
        delete assocation
        """
        # login and create session
        session, cookie_id, response = self.gk_service.login_create_session(
    ...
    @attr(env=['test'], priority=1)
    def test_user_perm_assoc_api_del_no_data(self):
        """
        GATEKEEPER_USER_PERM_ASSOC_API_010 test_user_perm_assoc_api_del_no_data
