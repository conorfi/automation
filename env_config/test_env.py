...
config['api']['gk']['user_app_v1'] = {}
config['api']['gk']['user_app_v1']['post'] = 'api/v1/userapplication/'
config['api']['gk']['user_app_v1']['id'] = 'api/v1/userapplication/%s/%s'
config['api']['gk']['user_apps_v1'] = 'api/v1/userapplications/'
config['api']['gk']['user_grp_v1'] = {}
config['api']['gk']['user_grp_v1']['post'] = 'api/v1/usergroup/'
config['api']['gk']['user_grp_v1']['id'] = 'api/v1/usergroup/%s/%s'
config['api']['gk']['user_grps_v1'] = 'api/v1/usergroups/'
config['api']['gk']['user_org_v1'] = {}
config['api']['gk']['user_org_v1']['post'] = 'api/v1/userorganization/'
config['api']['gk']['user_org_v1']['id'] = 'api/v1/userorganization/%s/%s'
config['api']['gk']['user_orgs_v1'] = 'api/v1/userorganizations/'
config['api']['gk']['grp_perm_v1'] = {}
config['api']['gk']['grp_perm_v1']['post'] = 'api/v1/grouppermission/'
config['api']['gk']['grp_perm_v1']['id'] = 'api/v1/grouppermission/%s/%s'
config['api']['gk']['grp_perms_v1'] = 'api/v1/grouppermissions/'
config['api']['gk']['user_perm_v1'] = {}
config['api']['gk']['user_perm_v1']['post'] = 'api/v1/userpermission/'
config['api']['gk']['user_perm_v1']['id'] = 'api/v1/userpermission/%s/%s'
config['api']['gk']['user_perms_v1'] = 'api/v1/userpermissions/'
config['api']['gk']['grp_app_v1'] = {}
